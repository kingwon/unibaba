...
<div class="win8mi_fw cl">
  <ul class="win8mi_ffirst">
    <h3>关于我们</h3>
    <li><a href="#" target="_blank">磨房简介</a></li>
    <li><a href="#" target="_blank">加入磨房</a></li>
  ...
  <ul>
    <h3>帮助中心</h3>
    <li><a href="#" target="_blank">玩转磨房</a></li>
  ...
  <ul>
    ...
    <li class="weixin"><a href="#" target="_blank">mofangweixin</a></li>
  </ul>
  <ul class="win8mi_flast">
    <h3>移动应用</h3>
    <li class="win8mi_fphone"><a href="#" target="_blank">磨房社区</a></li>
    <li class="win8mi_fphone"><a href="#" target="_blank">磨房活动</a></li>
  </ul>
  <div class="win8mi_ewm"> <img alt="二维码图片" src="template/win8mi_third_mofang3/src/img/dycode.jpg"> </div>
</div>
    <div class="clear"></div>	
<div id="ft" class="wp cl">
<div id="frt" style="padding-top: 10px; color: #818181;">
<p>Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank" style="color: #818181;">Licensed</a><?php } ?>&copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank" style="color: #818181;">Comsenz Inc.</a><a style="padding-left: 10px; color: #818181;">技术支持： 时代模板 - Discuz! 第三方模板提供商</a>
            <?php if($_G['setting']['icp']) { ?> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #818181;"><?php echo $_G['setting']['icp'];?> 号</a> <?php } ?>
            </p>
