...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1401800033, '5', './data/template/6_5_member_login.tpl.php', './template/win8mi_third_mofang3', 'member/login')
