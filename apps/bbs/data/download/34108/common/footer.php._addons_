...
<!--{if empty($topic) || ($topic[usefooter])}-->
    ...
    <div id="footer" class="cl">
        ...
        <div class="widget" style="text-align: right;">
               <!-- 底部logo -->
              <p class="ftlogo"><img src="template/jeavi_where/style/ftlogo.png" alt="" border="0"></p>
               <!-- 底部logo -->
               <!-- 第三方图标 -->
        ...
        <div class="widget-2 last widget">
             ...
             <p>
              ...
              <p>Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--> 
