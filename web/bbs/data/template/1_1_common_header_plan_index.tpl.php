...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1397496593, '1', './data/template/1_1_common_header_plan_index.tpl.php', './template/default', 'common/header_plan_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1397496593, '1', './data/template/1_1_common_header_plan_index.tpl.php', './template/default', 'common/header_plan_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1397496593, '1', './data/template/1_1_common_header_plan_index.tpl.php', './template/default', 'common/header_plan_index')
;?>
